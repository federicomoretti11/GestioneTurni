  ...
  return (
    <div className="flex h-screen bg-[#FAFAF8]">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        <Header nomeUtente={`${profile?.nome} ${profile?.cognome}`} ruolo="dipendente" userId={user!.id} navItems={navItems} tenantName={tenantName} chatUserId={user!.id} isSuperAdmin={!!(profile as { is_super_admin?: boolean } | null)?.is_super_admin} />
