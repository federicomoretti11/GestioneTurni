...
export function ChatPanelSlide({ userId }: { userId: string }) {
  ...
  // Realtime sulla conversazione selezionata
  useEffect(() => {
    ...
    <>
      ...
      >
        ...
        <div className="bg-slate-900 text-white px-4 py-3 flex items-center justify-between flex-shrink-0">
          ...
          <button onClick={() => setAperto(false)} className="text-slate-400 hover:text-white text-lg leading-none flex-shrink-0 ml-2">×</button>
        </div>
